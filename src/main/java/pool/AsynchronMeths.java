...
public class AsynchronMeths {
    ...
    public static void main(String[] args) throws Exception {
        AsynchronMeths.runAsyncExample();
        AsynchronMeths.supplyAsyncExample();
        AsynchronMeths.thenRunExample();
        AsynchronMeths.thenAcceptExample();
        AsynchronMeths.thenApplyExample();
        AsynchronMeths.thenComposeExample();
        AsynchronMeths.thenCombineExample();
        AsynchronMeths.allOfExample();
        AsynchronMeths.anyOfExample();
    }
}